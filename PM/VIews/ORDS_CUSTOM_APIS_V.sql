...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "WKSP_XXPM"."ORDS_CUSTOM_APIS_V" ("TYPE", "OBJECT_ALIAS", "PROTECTED", "TOTAL_ROWS", "SUM_PROTECTED", "ORA_INVOKING_USER") DEFAULT COLLATION "USING_NLS_COMP"  AS 
  SELECT TYPE                      TYPE 

--------------------------------------------------------
--  DDL for View XXCT_NOT_REOPEND_DOSSIERS_V
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "WKSP_XXCT"."XXCT_NOT_REOPEND_DOSSIERS_V" ("DOSSIER_ID", "PARTNER_ID", "FINANCIAL_CLOSE", "ACTION_START_DATE", "ACTION_END_DATE", "DOSSIER_TYPE", "PRODUCT_GROUP_CODE") DEFAULT COLLATION "USING_NLS_COMP"  AS 

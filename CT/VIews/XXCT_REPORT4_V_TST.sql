--------------------------------------------------------
--  DDL for View XXCT_REPORT4_V_TST
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "WKSP_XXCT"."XXCT_REPORT4_V_TST" ("DOSSIER_ID", "BRAND", "CENTER_CODE", "DIVISION", "CHANNEL", "CATEGORY_NAME", "PRODUCT", "COMMITMENT", "INVOICED_AMOUNT", "DELIVERD_VALUE", "TRANSPOST") DEFAULT COLLATION "USING_NLS_COMP"  AS 
  SELECT  dossier_id,
          brand,
          center_code,
          division,
...
--    AND (   UPPER (division) 
--        LIKE  DECODE (NVL (v ('P114_DIVISION'), 'ALL')
--                     ,   'ALL', '%'
--                     ,    v ('P114_DIVISION')
--                     )

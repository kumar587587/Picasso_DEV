--------------------------------------------------------
--  DDL for Function XX2SPM_HASH_VALUE
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "WKSP_XXCT"."XX2SPM_HASH_VALUE" ( p_table_name IN VARCHAR2 )
   RETURN raw
   IS
   ...
   BEGIN
      ...
      END LOOP;
      --
      --xxice_debug_pkg.debug_cs( c_routine_name, 'ODIS '||p_table_name||' file contents' ,l_clob );  
      --

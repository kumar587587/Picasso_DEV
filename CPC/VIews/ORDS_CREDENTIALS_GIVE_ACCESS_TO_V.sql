...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "WKSP_XXCPC"."ORDS_CREDENTIALS_GIVE_ACCESS_TO_V" ("CLIENT_NAME", "PRIVILEGE_NAME", "MODULE_NAME", "PATTERN") DEFAULT COLLATION "USING_NLS_COMP"  AS 

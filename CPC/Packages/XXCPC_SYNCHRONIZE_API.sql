--------------------------------------------------------
--  DDL for Package XXCPC_SYNCHRONIZE_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "WKSP_XXCPC"."XXCPC_SYNCHRONIZE_API" 
IS        
  /****************************************************************       
   *       
   * PROGRAM NAME       
   *  XXCPC_SYNCHRONIZE_API       
   *       
   * DESCRIPTION       
   ...
   **************************************************************/     
   gc_package_name   CONSTANT    VARCHAR(50) := 'XXCPC_SYNCHRONIZE_API';
   g_synchronize_job_active      BOOLEAN := FALSE;
...
--   ;
   ...
   -- Function to 
   ---------------------------------------------------------------------------------------------  
   FUNCTION bubbel_sort ( p_input_array    IN  xxcpc_array_varchar_type)
   RETURN xxcpc_array_varchar_type;
   --
   ...
   -- Procedure that calls the main procedure for all records in xxcpc_tables.   
   ---------------------------------------------------------------------------------------------         
   PROCEDURE synchronize( p_spm_table_name IN VARCHAR2, p_cpc_number_of_records IN NUMBER, p_context IN NUMBER , p_cpc_hash IN VARCHAR2, p_spm_number_of_rows in NUMBER , p_apex_id in number )          
   ;
   --    
   ---------------------------------------------------------------------------------------------
   ...
   , p_cpc_all_fields      IN OUT VARCHAR2
   );   

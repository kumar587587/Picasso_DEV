--------------------------------------------------------
--  DDL for Package XXCPC_EXPORT_FILES_API
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "WKSP_XXCPC"."XXCPC_EXPORT_FILES_API" 
IS        
   ...
   **************************************************************/       
   gc_package_name   CONSTANT    VARCHAR(50) := 'XXCPC_EXPORT_FILES_API'; 
   --
